...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m8(group) => "已创建自动组 ${group}。如需可在代理页选中它。";

  static String m9(group) => "已恢复 ${group} 的自动选优";

  static String m10(count) => "${count} 个条目";

  static String m11(label) => "${label}当前已存在";

  static String m12(timezone) => "恢复为 ${timezone}";

  static String m13(detail) => "无法对齐系统时区（${detail}）";

  static String m14(timezone) => "系统时区已恢复为 ${timezone}";

  static String m15(name) => "${name} 已是最新版本";
  ...
  static String m32(success, fail) => "${success} 可达 · ${fail} 失败";

  static String m33(count) => "${count} 个路由目标";

  static String m34(count) => "已有 ${count} 个节点。点击节点旁的测速按钮检查连通性。";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "geoIdentityRestoreOsTimezoneDesc": m12,
    ...
    "geoIdentityTimezoneAlignFailed": m13,
    ...
    "geoIdentityTimezoneRestored": m14,
