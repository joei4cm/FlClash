...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(node) => "当前节点：${node}";

  static String m1(node) => "手动覆盖：${node}";

  static String m2(region) => "锁定地区：${region}";
  ...
  static String m9(group) => "已创建自动组 ${group}。如需可在代理页选中它。";

  static String m10(group) => "已恢复 ${group} 的自动选优";

  static String m11(count) => "${count} 个条目";

  static String m12(label) => "${label}当前已存在";

  static String m13(timezone) => "恢复为 ${timezone}";

  static String m14(detail) => "无法对齐系统时区（${detail}）";

  static String m15(timezone) => "系统时区已恢复为 ${timezone}";

  static String m16(name) => "${name} 已是最新版本";

  static String m17(name) => "${name} 已更新";

  static String m18(name) => "正在更新 ${name}...";
  ...
  static String m33(success, fail) => "${success} 可达 · ${fail} 失败";

  static String m34(count) => "${count} 个路由目标";

  static String m35(count) => "已有 ${count} 个节点。点击节点旁的测速按钮检查连通性。";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "geoIdentityRestoreOsTimezoneDesc": m13,
    ...
    "geoIdentityTimezoneAlignFailed": m14,
    ...
    "geoIdentityTimezoneRestored": m15,
    ...
    "groupTypeUrlTest": MessageLookupByLibrary.simpleMessage("自动测速"),
    ...
    "restoreAutoSelect": MessageLookupByLibrary.simpleMessage("恢复自动"),
    ...
    "serviceProbeCategorySocial": MessageLookupByLibrary.simpleMessage("社交"),
    "serviceProbeCategoryStreaming": MessageLookupByLibrary.simpleMessage(
      "流媒体",
    ),
    "serviceProbeCurrentNode": MessageLookupByLibrary.simpleMessage("当前节点"),
    "serviceProbeDisclaimer": MessageLookupByLibrary.simpleMessage(
      "通过当前节点检测各类服务的 HTTP 可达性与延迟，并非流媒体解锁或账号地区测试。",
    ),
