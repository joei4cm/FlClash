...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(type) => "Авто · ${type}";
  ...
  static String m9(group) => "Автовыбор восстановлен для ${group}";

  static String m10(count) => "${count} записей";

  static String m11(label) => "Текущий ${label} уже существует";

  static String m12(timezone) => "Восстановить ${timezone}";

  static String m13(detail) =>
      "Не удалось выровнять системную таймзону (${detail})";

  static String m14(timezone) => "Часовой пояс ОС восстановлен в ${timezone}";

  static String m15(name) => "Для ${name} уже установлена последняя версия";
  ...
  static String m32(success, fail) => "${success} доступно · ${fail} ошибок";

  static String m33(count) => "Маршрутов: ${count}";
