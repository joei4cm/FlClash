...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(type) => "Auto · ${type}";
  ...
  static String m9(group) => "Auto select restored for ${group}";

  static String m10(count) => "${count} entries";

  static String m11(label) => "Current ${label} already exists";

  static String m12(timezone) => "Restore ${timezone}";

  static String m13(detail) => "Could not align OS timezone (${detail})";

  static String m14(timezone) => "OS timezone restored to ${timezone}";

  static String m15(name) => "${name} is already up to date";
  ...
  static String m19(count) => "${count} hours";
  ...
  static String m32(success, fail) => "${success} reachable · ${fail} failed";

  static String m33(count) => "${count} route(s)";
