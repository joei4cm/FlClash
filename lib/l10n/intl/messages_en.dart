...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m10(group) => "Auto select restored for ${group}";

  static String m11(count) => "${count} entries";

  static String m12(label) => "Current ${label} already exists";

  static String m13(timezone) => "Restore ${timezone}";

  static String m14(detail) => "Could not align OS timezone (${detail})";

  static String m15(timezone) => "OS timezone restored to ${timezone}";
  ...
  static String m33(success, fail) => "${success} reachable · ${fail} failed";

  static String m34(count) => "${count} route(s)";
